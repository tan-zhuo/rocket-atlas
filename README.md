...
一个公开知识驱动的运载火箭系统化可视化教育平台。目标不是收集最多的参数，而是把散落在
NASA 技术报告、发射服务用户手册、官方白皮书与事故调查报告里的公开信息，整理成能回答
**「为什么这样设计」** 的知识结构。
...
- **火箭百科** `/rockets` — 按国家、状态、推进剂、级数、年代、可回收性筛选；卡片 / 表格双视图
